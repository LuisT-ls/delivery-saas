        ...
        <div className="col-lg-8 mx-auto">
          ...
          <div className="bg-light p-4 rounded mb-5">
            ...
            <div className="row text-center">
              ...
              <div className="col-md-3 mb-3">
                <Image src="/icons/firebase.svg" alt="Firebase" width={48} height={48} className="mb-2" />
              ...
              <div className="col-md-3 mb-3">
                <Image src="/icons/typescript.svg" alt="TypeScript" width={48} height={48} className="mb-2" />
